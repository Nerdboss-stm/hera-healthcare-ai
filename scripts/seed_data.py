...
PATIENTS = [
    # ESI-1: Life-threatening
    {
        ...
        "heart_rate": 38, "respiratory_rate": 6, "body_temperature": 35.2,
        "oxygen_saturation": 78, "systolic_bp": 65, "diastolic_bp": 35,
        "age": 72, "gender": "male",
    ...
    },
    {
        ...
        "heart_rate": 145, "respiratory_rate": 5, "body_temperature": 35.0,
        "oxygen_saturation": 72, "systolic_bp": 75, "diastolic_bp": 38,
    ...
    # ESI-2: Emergent high-risk
    {
        ...
        "heart_rate": 110, "respiratory_rate": 24, "body_temperature": 37.2,
        "oxygen_saturation": 93, "systolic_bp": 165, "diastolic_bp": 95,
        "age": 58, "gender": "male",
    ...
    },
    {
        ...
        "heart_rate": 88, "respiratory_rate": 18, "body_temperature": 37.0,
        "oxygen_saturation": 96, "systolic_bp": 192, "diastolic_bp": 108,
    ...
    },
    {
        ...
        "heart_rate": 128, "respiratory_rate": 28, "body_temperature": 39.8,
        "oxygen_saturation": 90, "systolic_bp": 82, "diastolic_bp": 48,
        "age": 82, "gender": "male",
    ...
    },
    {
        ...
        "heart_rate": 132, "respiratory_rate": 30, "body_temperature": 37.1,
        "oxygen_saturation": 88, "systolic_bp": 78, "diastolic_bp": 42,
    ...
    # ESI-3: Urgent — needs labs/imaging
    {
        ...
        "heart_rate": 92, "respiratory_rate": 18, "body_temperature": 38.2,
        "oxygen_saturation": 98, "systolic_bp": 128, "diastolic_bp": 78,
        "age": 28, "gender": "male",
        "medical_history": [],
        "current_medications": [],
        "allergies": [],
    },
    {
        ...
        "heart_rate": 98, "respiratory_rate": 22, "body_temperature": 38.6,
        "oxygen_saturation": 94, "systolic_bp": 118, "diastolic_bp": 72,
    ...
    },
    {
        ...
        "heart_rate": 85, "respiratory_rate": 16, "body_temperature": 37.0,
        "oxygen_saturation": 97, "systolic_bp": 145, "diastolic_bp": 88,
        "age": 64, "gender": "male",
    ...
    },
    {
        ...
        "heart_rate": 102, "respiratory_rate": 18, "body_temperature": 36.8,
        "oxygen_saturation": 96, "systolic_bp": 105, "diastolic_bp": 62,
    ...
    # ESI-3: Moderate urgent
    {
        ...
        "heart_rate": 82, "respiratory_rate": 16, "body_temperature": 37.9,
        "oxygen_saturation": 99, "systolic_bp": 132, "diastolic_bp": 82,
        "age": 42, "gender": "male",
    ...
    },
    {
        ...
        "heart_rate": 95, "respiratory_rate": 19, "body_temperature": 37.1,
        "oxygen_saturation": 96, "systolic_bp": 110, "diastolic_bp": 68,
    ...
    # ESI-4: Less urgent, single resource
    {
        ...
        "heart_rate": 78, "respiratory_rate": 14, "body_temperature": 36.9,
        "oxygen_saturation": 99, "systolic_bp": 124, "diastolic_bp": 76,
        "age": 32, "gender": "male",
        "medical_history": [],
        "current_medications": [],
        "allergies": ["latex"],
    },
    {
        ...
        "oxygen_saturation": 99, "systolic_bp": 118, "diastolic_bp": 72,
    ...
    },
    {
        ...
        "heart_rate": 70, "respiratory_rate": 14, "body_temperature": 36.8,
        "oxygen_saturation": 100, "systolic_bp": 120, "diastolic_bp": 74,
        "age": 22, "gender": "male",
        "medical_history": [],
        "current_medications": [],
        "allergies": [],
    },
    {
        ...
        "heart_rate": 74, "respiratory_rate": 14, "body_temperature": 36.8,
        "oxygen_saturation": 99, "systolic_bp": 116, "diastolic_bp": 72,
    ...
    # ESI-5: Non-urgent / routine
    {
        ...
        "heart_rate": 76, "respiratory_rate": 14, "body_temperature": 36.7,
        "oxygen_saturation": 99, "systolic_bp": 142, "diastolic_bp": 88,
        "age": 56, "gender": "male",
    ...
    },
    {
        ...
        "heart_rate": 68, "respiratory_rate": 12, "body_temperature": 36.6,
        "oxygen_saturation": 99, "systolic_bp": 118, "diastolic_bp": 74,
    ...
    # More mid-range cases to fill out Medium/High risk
    {
        ...
        "heart_rate": 112, "respiratory_rate": 22, "body_temperature": 37.0,
        "oxygen_saturation": 99, "systolic_bp": 138, "diastolic_bp": 86,
    ...
    },
    {
        ...
        "heart_rate": 105, "respiratory_rate": 24, "body_temperature": 37.0,
        "oxygen_saturation": 99, "systolic_bp": 90, "diastolic_bp": 55,
        "age": 3, "gender": "male",
        "medical_history": [],
        "current_medications": [],
        "allergies": [],
    ...
    for i, patient in enumerate(PATIENTS, 1):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                results["success"] += 1
                results["risk_levels"][risk_level] = results["risk_levels"].get(risk_level, 0) + 1
                results["esi_levels"][str(esi)] = results["esi_levels"].get(str(esi), 0) + 1
