...
CLINICAL_KNOWLEDGE = {
    ...
    "back pain": [
        Diagnosis(
            ...
            ruling_out=["normal MRI", "no neurological deficit"],
        ),
        Diagnosis(
            ...
            ruling_out=["radiculopathy", "neurological deficit"],
        ),
        Diagnosis(
            ...
            ruling_out=["young age", "normal MRI"],
        ),
        Diagnosis(
            ...
            ruling_out=["normal CT", "no hematuria"],
        ),
    ],
    "skin wound": [
        Diagnosis(
            ...
            ruling_out=["no fever", "no spreading"],
        ),
        Diagnosis(
            condition="Abscess",
            icd10_code="L02.91",
            ...
            ruling_out=["no fluctuance", "no drainage"],
        ),
        Diagnosis(
            condition="Laceration requiring repair",
            icd10_code="T14.1",
            probability=0.0,
            supporting_evidence=[
                "open wound",
            ...
            ruling_out=["superficial", "no active bleeding"],
        ),
    ],
    "joint pain": [
        Diagnosis(
            ...
            ruling_out=["young age", "acute onset", "fever"],
        ),
        Diagnosis(
            condition="Gout",
            icd10_code="M10.9",
            ...
            ruling_out=["normal uric acid", "chronic symptoms"],
        ),
        Diagnosis(
            ...
            ruling_out=["afebrile", "multiple joints", "chronic"],
        ),
    ],
}
...
RECOMMENDED_TESTS = {
    ...
    "M51.16": ["MRI Lumbar Spine", "X-ray L-spine", "Neurological exam"],
    "M54.5": ["X-ray L-spine", "Physical exam", "NSAIDs trial"],
    "M48.06": ["MRI Lumbar Spine", "EMG/NCS", "X-ray L-spine"],
    "N20.0": ["CT Abdomen/Pelvis non-contrast", "Urinalysis", "BMP"],
    "L03.90": ["CBC", "Blood cultures if febrile", "Wound culture"],
    "L02.91": ["I&D", "Wound culture", "CBC"],
    "M19.90": ["X-ray affected joint", "ESR/CRP", "Rheumatoid factor"],
    "M10.9": ["Serum uric acid", "Joint aspiration", "CBC", "BMP"],
    "M00.9": ["Joint aspiration (STAT)", "CBC", "Blood cultures", "ESR/CRP"],
}
