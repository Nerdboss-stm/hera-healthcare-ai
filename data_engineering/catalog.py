    ...
    def _register_defaults(self):
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ...
                    ColumnMetadata(
                        "heart_rate", "float", "Heart rate in BPM", example="88.0"
                    ),
                    ColumnMetadata(
                        "respiratory_rate",
                        "float",
                    ...
                    ColumnMetadata(
                        "oxygen_saturation", "float", "SpO2 percentage", example="96.0"
                    ),
                    ColumnMetadata(
                        "systolic_bp",
                        "float",
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ...
                    ColumnMetadata(
                        "note_text", "str", "Full clinical note text", pii=True
                    ),
            ...
            DatasetEntry(
                ...
                columns=[
                    ...
                    ColumnMetadata(
                        "medications",
                        "list[dict]",
                        "Extracted medication names",
                        pii=True,
                    ),
                    ColumnMetadata("conditions", "list[dict]", "Diagnosed conditions"),
                    ColumnMetadata(
                        "procedures", "list[dict]", "Medical procedures mentioned"
                    ),
                    ColumnMetadata("lab_values", "list[dict]", "Lab test results"),
                    ColumnMetadata(
                        "vital_signs", "list[dict]", "Vital sign mentions in text"
                    ),
                ],
            )
        )
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ...
                    ColumnMetadata(
                        "disposition", "str", "Recommended care disposition"
                    ),
                    ColumnMetadata(
                        "consensus_score", "float", "Agent agreement score [0, 1]"
                    ),
                    ColumnMetadata(
                        "reasoning_audit", "list[dict]", "Full reasoning chain"
                    ),
                ],
            )
        )
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ColumnMetadata(
                        "risk_score", "float", "Probability of adverse outcome [0, 1]"
                    ),
                    ColumnMetadata(
                        "prediction",
                        "str",
                    ...
                    ColumnMetadata(
                        "features_used", "dict", "Input features including derived"
                    ),
                ],
            )
        )
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ...
                    ColumnMetadata(
                        "total_corpus_size", "int", "Total docs in knowledge base"
                    ),
                ],
            )
        )
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ColumnMetadata(
                        "summary", "str", "Generated summary text", pii=True
                    ),
                    ColumnMetadata(
                        "compression", "float", "Compression ratio percentage"
                    ),
                    ColumnMetadata(
                        "input_length", "int", "Source note character count"
                    ),
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ColumnMetadata(
                        "overall_score", "float", "Weighted evaluation score [0, 1]"
                    ),
                    ColumnMetadata(
                        "factual_consistency", "dict", "Source-summary alignment score"
                    ),
                    ColumnMetadata(
                        "hallucination", "dict", "Hallucination detection result"
                    ),
                    ColumnMetadata(
                        "medical_accuracy", "dict", "Clinical correctness score"
                    ),
                    ColumnMetadata(
                        "clinical_safety", "dict", "Patient safety assessment"
                    ),
                    ColumnMetadata(
                        "pass_threshold", "bool", "Whether output passes quality gate"
                    ),
                ],
            )
        )
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ColumnMetadata(
                        "bundle", "dict", "Complete FHIR R4 Bundle resource"
                    ),
                    ColumnMetadata("resource_count", "int", "Number of FHIR resources"),
                    ColumnMetadata(
                        "resource_types", "list[str]", "Types of resources included"
                    ),
                ],
            )
        )
        ...
        self.register(
            DatasetEntry(
                ...
                columns=[
                    ColumnMetadata(
                        "encounter_id", "int", "Auto-incremented encounter key"
                    ),
                    ...
                    ColumnMetadata(
                        "pipeline_latency_ms", "float", "End-to-end pipeline latency"
                    ),
                    ColumnMetadata(
                        "fhir_resource_count", "int", "FHIR resources generated"
                    ),
                ],
            )
        )
            ...
            if ds.last_updated:
                try:
                    last = datetime.fromisoformat(
                        ds.last_updated.replace("Z", "+00:00")
                    )
